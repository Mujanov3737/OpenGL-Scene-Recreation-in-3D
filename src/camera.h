...
public:
    ...
    {
        Position = glm::vec3(posX, posY, posZ);glm::ortho(0.0f, 200.0f, 0.0f, 200.0f, 0.1f, 100.0f);
    ...
    void ProcessMouseScroll(float yoffset, float xoffset, bool constrainSpeed = true)
    {
        MovementSpeed += (float)yoffset;
        MovementSpeed -= (float)xoffset;
